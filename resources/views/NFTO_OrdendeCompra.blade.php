...
<div class="bg-slate-100">
    <div class="max-w-3xl mx-auto my-8 bg-white p-8 rounded-xl shadow text-slate-800 text-sm">
        ...
        <section class="grid grid-cols-2 gap-4 mb-4 text-[11px]">
            ...
            <div class="border border-slate-200 rounded-lg p-3">
                <p class="text-[10px] font-semibold text-slate-500 mb-1">PROVEEDOR</p>
        ...
        <section class="grid grid-cols-2 gap-4 mb-4 text-[11px]">
            <div class="border border-slate-200 rounded-lg p-3">
                <p class="text-[10px] font-semibold text-slate-500 mb-1">ENTREGA</p>
        ...
        <section class="mb-6 text-[10px] text-slate-500 leading-snug">
