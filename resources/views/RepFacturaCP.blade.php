                ...
                <table style="width: 98% !important;">
                    ...
                    @foreach ($DetPagos as $DetallePago)
                        ...
                        <tr>
                            ...
                            <td style="font-weight: normal; border-style: solid; border-width: 2px; border-color: #1a1e21; text-align: center; align-content: center">{{$doc_ant['EquivalenciaDR']}}<br><label style="color: white">&nbsp;</label></td>
