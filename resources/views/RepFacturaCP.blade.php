                ...
                <table style="width: 98% !important;">
                    ...
                    @foreach ($DetPagos as $DetallePago)
                        ...
                        <tr>
                            ...
                            <th style="font-weight: bold; border-style: solid; border-width: 2px; border-color: #1a1e21; text-align: center; align-content: center">{{$doc_ant['IdDocumento']}}</th>
                            ...
                            <th style="font-weight: bold; border-style: solid; border-width: 2px; border-color: #1a1e21; text-align: center; align-content: center">{{$DetallePago['FechaPago']}}</th>
                        </tr>
                    @endforeach
