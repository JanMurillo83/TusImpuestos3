<?php
    ...
    $orden = DB::table('notade_creditos')->where('id',$idorden)->first();
    $partidas = DB::table('partidas_notade_creditos')->where('facturas_id',$idorden)->get();
        ...
        <div class="container mt-5" style="margin-left: 1rem !important; margin-right: 1rem !important;">
            ...
            <div class="row">
                ...
                <div class="col-4" style="font-size: 10px !important;">
                    <label><b>TIPO DE COMPROBANTE:</b></label><label> E - Egreso</label><br>
                ...
                <div class="col-2" style="font-size: 10px !important;">
                    <label><b>NOTA FOLIO:</b></label> <label>{{$orden->serie.$orden->folio}}</label><br>
            ...
            <div class="row" style="margin-top: 5rem; margin-left: -2rem !important">
                <div class="col-8" style="font-size: 10px !important;">
                    ...
                    $tiporel = '';
                    $doctore = '';
                    if(count(\App\Models\DoctosRelacionados::where('docto_type','N')->where('docto_id',$orden->id)->get())>0){
                        $doctorel = \App\Models\DoctosRelacionados::where('docto_type','N')->where('docto_id',$orden->id)->first();
                        //dd($doctorel);
                        $facrel = \App\Models\NotadeCredito::where('id',$doctorel->rel_id)->first();
                        $doctore = $facrel->uuid;
