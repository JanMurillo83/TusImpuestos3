...
return new class extends Migration
{
    ...
    {
        Schema::create('par_facturas', function (Blueprint $table) {
            $table->id();
            $table->string('facturas_id')->nullable();
        ...
        Schema::create('par_facturas_team', function (Blueprint $table) {
            $table->integer('par_facturas_id');
    ...
    {
        Schema::dropIfExists('par_facturas');
    }
};
