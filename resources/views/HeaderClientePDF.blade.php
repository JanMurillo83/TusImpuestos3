    ...
    <div class="container mx-auto mt-2 ml-2">
        <div class="grid gap-6">
            <div class="row-span-1 mb-2">
                <div class="col-md-6">
                    <label style="font-weight: bold; font-size: 20px; color: #9f1239">Estado de Cuenta del cliente</label>
                    <div>
                        <label style="color: #aab2b3">Tus Impuestos - Cuentas por Cobrar</label>
                    </div>
                </div>
            </div>
            <hr>
