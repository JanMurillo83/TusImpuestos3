...
<head>
    ...
    $datos = app(AdminReportes::class)->reporte_cuentascobrar($fecha_inicial,$fecha_final,$cliente,$team_id);
    ...
    <div class="row">
        ...
        <div class="col-4">
            <center>
                ...
                <div><h3>Cuentas por cobrar</h3></div>
            </center>
        </div>
        <div class="col-4">
                ...
                @foreach($datos as $dato)
                    @if(trim($dato->concepto) == trim($clie))
                        <tr>
                            ...
                            $total_c+=$dato->cargo;
                            $total_a+=$dato->abono;
                            $gran_total_c+=$dato->cargo;
                            $gran_total_a+=$dato->abono;
                            ?>
                    @endif
                @endforeach
                <tfoot>
