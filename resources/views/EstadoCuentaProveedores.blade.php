...
<head>
    ...
    <title>{{ $empresa?->name }} - Estado de Cuenta de Proveedores</title>
...
<div class="container">
    ...
    @foreach($proveedores as $proveedor)
        <?php
            ...
            // Omitir proveedores sin movimientos en el rango
        ...
        <div class="row mb-3 {{ $primero ? 'no-page-break' : 'page-break' }}">
            <div class="col-12">
                <div class="section-title">Proveedor: {{ $proveedor?->clave }} - {{ $proveedor?->nombre }}</div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
