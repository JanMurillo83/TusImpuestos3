...
<div class="container mt-5" style="margin-left: 1rem !important; margin-right: 1rem !important;">
    ...
    <div class="row" style="font-size: 9px !important;">
        <table style="width: 98% !important;">
            <tr>
                ...
                <th style="font-weight: bold; border-style: solid; border-width: 1px; border-color: #1a1e21; text-align: center; align-content: center;vertical-align: top !important;">VALOR UNITARIO</th>
                <th style="font-weight: bold; border-style: solid; border-width: 1px; border-color: #1a1e21; text-align: center; align-content: center;vertical-align: top !important;">DESCUENTO</th>
    ...
    <div class="row" style="font-size: 10px !important;">
        <table style="width: 98% !important;">
            ...
            <tr>
                <td style="border-style: solid; border-width: 1px; border-color: #1a1e21; text-align: center; align-content: center;vertical-align: top !important;">ninguna</td>
                <td style="border-style: solid; border-width: 1px; border-color: #1a1e21; text-align: center; align-content: center;vertical-align: top !important;">ninguna</td>
    ...
    <table class="table table-bordered mt-2">
        ...
        <tr><td style="font-weight: bold">Sello SAT:</td></tr>
        <tr><td style="font-weight: normal">{{chunk_split($tfd['SelloSAT'] ?? '', 150)}}</td></tr>
        <tr><td style="font-weight: bold">Cadena Original:</td></tr>
        <tr><td style="font-weight: normal">{{chunk_split($cadenaOrigen ?? '', 150)}}</td></tr>
    </table>
