<?php
    ...
    $orden = DB::table('ordenes')->where('id',$idorden)->first();
        ...
        <div class="container mt-5">
            <div class="row border border-dark mt-2 ">
                ...
                <div class="col-8 mt-2 mb-2">
                    <center><h3 style="font-weight: bold">ORDEN DE COMPRA</h3></center>
                </div>
                <div class="col-2 mt-2 mb-2">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th style="font-size: larger; font-weight: bold; background-color: whitesmoke;text-align: center;">SOLICITO</th>
                        </tr>
                    </thead>
                        <tr>
                            <td style="font-size: larger; font-weight: normal; text-align: center;">{{$orden->observa ?? ''}}</td>
                            <td style="font-size: larger; font-weight: normal; text-align: center;">{{$orden->solicita ?? ''}}</td>
                        </tr>
                </table>
            </div>
            <hr>
