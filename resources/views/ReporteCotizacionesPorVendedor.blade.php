...
<head>
    ...
    <title>Reporte de Cotizaciones por Vendedor</title>
    ...
    <?php
        ...
        $grouped = $cotizaciones->groupBy(function($c) {
            return $c->nombre_elaboro ?: 'Sin vendedor';
        });
    ?>
</head>
<body>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <center>
                    <h1>Reporte de Cotizaciones por Vendedor</h1>
                    <h3>{{$empresa->name}}</h3>
                    @if(isset($fecha_inicio) && $fecha_inicio != null && isset($fecha_fin) && $fecha_fin != null)
        ...
        <div class="row mb-2">
            <div class="col-12">
                <h5 style="background-color:#B4C6E7;padding:5px;margin-bottom:0;">{{ $vendedor }} ({{ $items->count() }} cotizaciones)</h5>
                <table class="table table-bordered table-striped" style="font-size: 8px !important;">
                    ...
                    <tfoot>
                        <tr style="font-weight: bold; font-size: 10px !important; background-color:#D9E2F3;">
                            <td colspan="5">Subtotal {{ $vendedor }} ({{ $items->count() }}):</td>
        ...
        <div class="row mt-3">
            <div class="col-12">
                <div class="alert alert-info" style="font-size: 10px;">
                    ...
                    <strong>Vendedores:</strong> {{$grouped->count()}}
                </div>
            </div>
        </div>
    </div>
